...
def _a(s):
    """Nettoie le texte pour compatibilite PDF (Helvetica = latin-1 uniquement)."""
    s = (s.replace('\xe9','e').replace('\xe8','e').replace('\xea','e').replace('\xeb','e')
          ...
          .replace('\u2019',"'").replace('\u2018',"'"))
    # Supprimer tout caractere hors latin-1 (emojis, symboles Unicode)
